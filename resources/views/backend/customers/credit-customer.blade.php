  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Manage Customer Credit</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="card">
        ...
        <div class="card-header">
          <h3>Credit Customers List
              <a class="btn btn-success float-right btn-sm" target="_blank" href="{{route('customers.credit.pdf')}}"><i class="fa fa-download"> Downlod PDF</i></a>
          </h3>
        </div>
        <div class="card-body">
              ...
              @foreach($alldata as $key => $payment)
               @if($payment->invoice->status=='1')
                <tr>
                    ...
                    <td>
                      <a title="edit" class="btn btn-sm btn-primary" href="{{route('customers.edit.invoice',$payment->invoice_id)}}">
