...
<html>
<head>
	<title>Product Wise Stocks Report PDF</title>
</head>
<body>
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12">
				<table width="100%">
					<tbody>
						<tr>
							<td width="25%"></td>
							<td style="font-size: 20px;"><strong>Product Wise Stock Report</strong></td>
							<td width="25%"></td>
						</tr>
					</tbody>
				</table>
		...
		<div class="row">
			<div class="col-md-12">
				<br>
				<strong>Supplier Name: {{$product['supplier']['name']}}</strong>
				<br>
